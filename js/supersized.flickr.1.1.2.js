	...
	switch(options.sort_direction){
    	...
    	switch(options.source){
	    	...
	    	case 3:		//From a Group
	    		...
	    		break;
		case 4:		//From tags
	    		var flickrURL =  'http://api.flickr.com/services/rest/?format=json&method=flickr.photos.search&api_key=' + options.api_key + '&tags=' + options.tags + '&tag_mode=all&per_page=' + options.total_slides + '&sort=' + sort_order + '&jsoncallback=?';
	    		break;
	    }
